...
public class PoiExportExcelUtils {
	    ...
	    // 传入要导入的数据  
	    public PoiExportExcelUtils(String title,String[] rowName,List<Object[]>  dataList,HttpServletResponse  response){  
	        this.title=title;  
	    ...
	    public void exportData(){  
	        try {  
	            ...
	            //  让列宽随着导出的列长自动适应  
	             ...
	             sheet.autoSizeColumn((short)11); //调整第十列宽度  
 ...
 public HSSFCellStyle getStyle(HSSFWorkbook workbook) {    
     ...
     //style.setDataFormat(workbook.createDataFormat().getFormat("yyyy年MM月dd日hh时mm分ss秒"));  
     return style;    
}    
}
